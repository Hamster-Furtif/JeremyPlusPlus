...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_preflop" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#a67f50e0#;
   pragma Export (C, u00001, "test_preflopB");
   ...
   u00132 : constant Version_32 := 16#a4d395fb#;
   pragma Export (C, u00132, "botioB");
   u00133 : constant Version_32 := 16#8ce5e3a3#;
   pragma Export (C, u00133, "botioS");
   u00134 : constant Version_32 := 16#1400dd98#;
   pragma Export (C, u00134, "montecarloB");
   u00135 : constant Version_32 := 16#453f66bf#;
   pragma Export (C, u00135, "montecarloS");
   u00136 : constant Version_32 := 16#cd2959fb#;
   pragma Export (C, u00136, "ada__numericsS");
   u00137 : constant Version_32 := 16#d34f9f29#;
   ...
   u00139 : constant Version_32 := 16#40a8df0e#;
   ...
   u00141 : constant Version_32 := 16#0d7f1a43#;
   pragma Export (C, u00141, "ada__calendarB");
   u00142 : constant Version_32 := 16#5b279c75#;
   pragma Export (C, u00142, "ada__calendarS");
   u00143 : constant Version_32 := 16#a99e1d66#;
   pragma Export (C, u00143, "system__os_primitivesB");
   u00144 : constant Version_32 := 16#b82f904e#;
   pragma Export (C, u00144, "system__os_primitivesS");
   u00145 : constant Version_32 := 16#b6166bc6#;
   pragma Export (C, u00145, "system__task_lockB");
   u00146 : constant Version_32 := 16#532ab656#;
   pragma Export (C, u00146, "system__task_lockS");
   u00147 : constant Version_32 := 16#1a9147da#;
   pragma Export (C, u00147, "system__win32__extS");
   u00148 : constant Version_32 := 16#e1c60b67#;
   pragma Export (C, u00148, "utilsB");
   u00149 : constant Version_32 := 16#b214871a#;
   pragma Export (C, u00149, "utilsS");
   u00150 : constant Version_32 := 16#83947c18#;
   pragma Export (C, u00150, "system__val_enumB");
   u00151 : constant Version_32 := 16#89bac3ad#;
   pragma Export (C, u00151, "system__val_enumS");
   u00152 : constant Version_32 := 16#3791e504#;
   pragma Export (C, u00152, "ada__strings__unboundedB");
   u00153 : constant Version_32 := 16#9fdb1809#;
   pragma Export (C, u00153, "ada__strings__unboundedS");
   u00154 : constant Version_32 := 16#144f64ae#;
   pragma Export (C, u00154, "ada__strings__searchB");
   u00155 : constant Version_32 := 16#c1ab8667#;
   pragma Export (C, u00155, "ada__strings__searchS");
   u00156 : constant Version_32 := 16#933d1555#;
   pragma Export (C, u00156, "system__compare_array_unsigned_8B");
   u00157 : constant Version_32 := 16#9ba3f0b5#;
   pragma Export (C, u00157, "system__compare_array_unsigned_8S");
   u00158 : constant Version_32 := 16#97d13ec4#;
   pragma Export (C, u00158, "system__address_operationsB");
   u00159 : constant Version_32 := 16#21ac3f0b#;
   pragma Export (C, u00159, "system__address_operationsS");
   u00160 : constant Version_32 := 16#a2250034#;
   pragma Export (C, u00160, "system__storage_pools__subpoolsB");
   u00161 : constant Version_32 := 16#cc5a1856#;
   pragma Export (C, u00161, "system__storage_pools__subpoolsS");
   u00162 : constant Version_32 := 16#6abe5dbe#;
   ...
   u00176 : constant Version_32 := 16#af9f2fd5#;
   ...
   u00180 : constant Version_32 := 16#f508d0da#;
   ...
   u00183 : constant Version_32 := 16#d25cc204#;
   pragma Export (C, u00183, "system__float_controlS");
   u00184 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00184, "system__img_lluB");
   u00185 : constant Version_32 := 16#4feffd78#;
   pragma Export (C, u00185, "system__img_lluS");
   u00186 : constant Version_32 := 16#62d0e74f#;
   pragma Export (C, u00186, "system__powten_tableS");
   u00187 : constant Version_32 := 16#faa9a7b2#;
   pragma Export (C, u00187, "system__val_realB");
   u00188 : constant Version_32 := 16#cc89f629#;
   pragma Export (C, u00188, "system__val_realS");
   u00189 : constant Version_32 := 16#b2a569d2#;
   pragma Export (C, u00189, "system__exn_llfB");
   u00190 : constant Version_32 := 16#8ede3ae4#;
   pragma Export (C, u00190, "system__exn_llfS");
   u00191 : constant Version_32 := 16#6ad59d2c#;
   pragma Export (C, u00191, "system__fat_fltS");
   u00192 : constant Version_32 := 16#18e0e51c#;
   pragma Export (C, u00192, "system__img_enum_newB");
   u00193 : constant Version_32 := 16#53ec87f8#;
   pragma Export (C, u00193, "system__img_enum_newS");
   u00194 : constant Version_32 := 16#62eb21d7#;
   pragma Export (C, u00194, "read_preflopB");
   u00195 : constant Version_32 := 16#e801110f#;
   pragma Export (C, u00195, "read_preflopS");
   u00196 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00196, "system__concat_4B");
   u00197 : constant Version_32 := 16#4cc4aa18#;
   pragma Export (C, u00197, "system__concat_4S");
   u00198 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00198, "system__concat_3B");
   u00199 : constant Version_32 := 16#39d0dd9d#;
   pragma Export (C, u00199, "system__concat_3S");
   ...
   u00203 : constant Version_32 := 16#e067ac8a#;
   pragma Export (C, u00203, "system__concat_6S");
   u00204 : constant Version_32 := 16#608e2cd1#;
   pragma Export (C, u00204, "system__concat_5B");
   u00205 : constant Version_32 := 16#b5fec216#;
   pragma Export (C, u00205, "system__concat_5S");
   u00206 : constant Version_32 := 16#ee101ba4#;
